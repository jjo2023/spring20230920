...
CREATE TABLE my_table14(
    col1 INT,
    col2 INT UNIQUE -- 이 컬럼에 중복딘 값을 넣을 수 없음
);
...
VALUE (11,NULL,NULL,NULL); -- NULL값 넣으면 NULL 들어감!! 값을 안넣어야 디폴드값 들어감!
INSERT INTO my_table17
...
INSERT INTO my_table18
VALUE (3,NULL,NULL); -- not ok
INSERT INTO my_table18(col1,col2)
VALUE (3,222); -- col3 NOT NULL이지만 DEFAULT값 있으므로 안넣어도 가능
INSERT INTO my_table18(col1)
VALUE (55); -- col3 NOT NULL이지만 DEFAULT값 있으므로 안넣어도 가능
...
CREATE TABLE my_table20(
    ...
    col3 INT CHECK ( col3 > 100 AND col3 < 2000)
);
DESC my_table20;
