...
public class Controller22 {
    ...
    public void method1(Integer page) throws SQLException {
        ...
        statement.setInt(1, (page - 1) * 10); // 1페이지
    ...
    // /main22/sub2?p=2
    @GetMapping("sub2")
    public void method2(@RequestParam(value = "p", defaultValue = "1") Integer page, Model model)
            throws SQLException {
        String sql = """
...
//                System.out.println(id + ":" + name);
    ...
    public void method3(@RequestParam(value = "p", defaultValue = "1") Integer page, Model model) throws SQLException {
        ...
        try(connection1;statement1;resultSet1){
            if (resultSet1.next()) {
                int cuntAll = resultSet1.getInt(1);
                lastPageNumber = ((cuntAll-1)/5)+1;
