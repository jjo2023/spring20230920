...
public class Controller36 {
    ...
    */
    ...
    /*
    고객 지우기 (착각해서 직원지움..-_-..ㅋ)
    axios.delete("/main36/sub12/5")
    axios.delete("/main36/sub12/7")
    axios.delete("/main36/sub12/9")
     */
    @DeleteMapping("sub12/{eid}")
    public void method12(@PathVariable Integer eid){
        int rows = dao.deleteByEmployeeId(eid);
